...
enum PaddingType {
  overAllScreen,
  relatedValueSeparation,
  notRelatedValueSeparation,
}
...
sealed class MyPadding {
  ...
  static EdgeInsets getPaddingFormat(
      {required PaddingType paddingType, EdgeInsets? edgeInsets}) {
    switch (paddingType) {
      case PaddingType.overAllScreen:
        return getDimensionEdgeInsets(
          multiplier: MultiplierConstant.dMOverAllScreen,
        );
      case PaddingType.notRelatedValueSeparation:
        return edgeInsets ??
            getDimensionEdgeInsets(
              multiplier: MultiplierConstant.dMNotRelatedValueSeparation,
            );
      case PaddingType.relatedValueSeparation:
        return edgeInsets ??
            getDimensionEdgeInsets(
...
sealed class SizeGetter{
  static double getHeight({required double multiplier,}){
    return sizeConstants.height*multiplier;
  }
  static double getWidth({required double multiplier,}){
    return sizeConstants.width*multiplier;
  }
}
